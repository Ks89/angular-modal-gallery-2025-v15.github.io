import{a as x,b as V,c as Ei,d as yi,e as D,f as h,g as b,h as T,i as S,j as Ci,k as w}from"./chunk-HDQY23TN.js";import{$ as Z,A as ne,Aa as Si,B as le,Ba as E,C as ae,Ca as fi,D as q,E as f,F as N,G as oe,Ga as vi,H as re,Ha as xi,I as me,J as ri,K as e,Ka as u,L as P,La as A,M as de,Oa as g,P as Y,Pa as I,Q as W,R as J,S as C,U as se,V as mi,W as ce,X as di,Y as si,Z as ci,bb as Ii,cb as _i,d as y,db as wi,eb as Ri,i as ai,ia as pi,ja as Di,k as K,l as z,la as gi,na as Gi,o as ie,oa as F,p as m,pa as ui,qa as ee,r as d,ra as O,s as p,sa as Q,t as oi,ta as te,u as B,ua as hi,va as X,w as s,wa as bi,x as i,xa as v,y as t,ya as U,z as n,za as pe}from"./chunk-PEHDONZZ.js";var ge,he=y(()=>{"use strict";D();T();C();A();I();E();w();ge=(()=>{class r{constructor(o,l,a){this.uiService=o,this.titleService=l,this.modalGalleryService=a,this.images=[...x],this.configHtml=b,this.configTs=h,this.titleService.titleEvent.emit("Examples - Array simple"),this.codeHtml='<button (click)="openModal(302, 0)">Open modal gallery id=1 at index=0</button>',this.codeTypescript=`
